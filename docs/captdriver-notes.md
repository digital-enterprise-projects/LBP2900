...
Ghi lại từ phiên thử cắm LBP2900 **trực tiếp vào Ubuntu 24.04** (`hn-kt-thao`) ngày 13/08/2026. Kết cục: driver mã nguồn mở có tiềm năng nhưng vướng lỗi kênh truyền của CUPS; bản vá trong repo này đưa nó vượt qua điểm chết, chưa kiểm chứng trọn vẹn tới tờ giấy.
...
**Trạng thái: bản vá đã vượt qua lỗi #16, chưa kiểm chứng tới tờ giấy in ra.** Việc còn lại nếu muốn theo tiếp:

1. Cắm lại máy in vào Ubuntu lúc máy in đang khoẻ (vừa in tốt trên Windows)
2. In thử — nếu ra giấy, gửi PR lên `mounaiban/captdriver` kèm chẩn đoán ở trên
3. Cân nhắc sửa patch thành fallback-only (mặc định giữ kênh CUPS) để dễ được merge
